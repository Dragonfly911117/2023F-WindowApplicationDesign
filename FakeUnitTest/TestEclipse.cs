...
namespace FakeUnitTest
{
    public class TestEclipse
    {
        ...
        private BadEclipse _shape;
        private Mock<IGraphics> _mockGraphics;

        [SetUp]
        public void Setup()
        {
            _shapeFactory = new EclipseFactory();
            _random = new FakeRandom();
            _randomNumbers = new List<int>();
            _shape = (BadEclipse)_shapeFactory.CreateShape(new List<int> { 1, 2, 3, 4 });
        ...
        [Test]
        public void TestEclipseHandleGetter()
        {
        ...
        [Test]
        public void TestEclipseHandleSetter()
        {
            var handles = _shape.Handles;
        ...
        [Test]
        public void TestEclipseDrawHandle()
        {
        ...
        {
            _shape = (BadEclipse)_shapeFactory.CreateShape(new List<int> { 3, 4, 1, 2 });
        ...
        [Test]
        public void TestEclipseDrawnWhileSelected()
        {
        ...
        [Test]
        public void TestEclipseProperties()
        {
            Assert.AreEqual(ShapeType.Eclipse, _shape.ShapeType);
            Assert.AreEqual(1, _shape.Coordinates[0].X);
            Assert.AreEqual(2, _shape.Coordinates[0].Y);
            Assert.AreEqual(3, _shape.Coordinates[1].X);
            Assert.AreEqual(4, _shape.Coordinates[1].Y);
            ...
            _shape.Color = Color.FromArgb(255, 132, 120, 222);
